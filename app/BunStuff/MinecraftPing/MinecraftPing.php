...
namespace Pterodactyl\BunStuff\MinecraftPing;
...
class MinecraftPing
{
	...
	public function Query( )
	{
        ...
        // Append avatar URL to each player
        if (isset($Data['players']) && isset($Data['players']['sample'])) {
            foreach ($Data['players']['sample'] as &$player) {
                $player['avatar'] = 'https://minotar.net/helm/' . $player['id'] . '/64.png';
            }
        }
